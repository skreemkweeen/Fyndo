...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [818],
  {
    1478: (t, e, i) => {
      ...
      function u(t) {
        let { children: e, isPresent: i } = t,
          ...
          { nonce: u } = (0, n.useContext)(l._);
        return (
          (0, n.useInsertionEffect)(() => {
            let { width: t, height: e, top: s, left: n } = a.current;
      ...
      let d = (t) => {
        ...
        return (
          ...
          "popLayout" === p &&
            (e = (0, s.jsx)(u, { isPresent: r, children: e })),
          (0, s.jsx)(a.O.Provider, { value: g, children: e })
        );
      };
      function c() {
        return new Map();
      ...
      let g = (t) => {
        let {
          ...
          [V, M] = (0, n.useState)(x);
        (0, v.L)(() => {
          ((w.current = !1), (T.current = x));
          for (let t = 0; t < V.length; t++) {
            let e = m(V[t]);
            P.includes(e) ? S.delete(e) : !0 !== S.get(e) && S.set(e, !1);
          }
        }, [V, P.length, P.join("-")]);
        let D = [];
        if (x !== b) {
          ...
          for (let e = 0; e < V.length; e++) {
            let i = V[e],
              s = m(i);
            P.includes(s) || (t.splice(e, 0, i), D.push(i));
          }
          ("wait" === u && D.length && (t = D), M(f(t)), A(x));
          return;
        }
        let { forceRender: C } = (0, n.useContext)(r.p);
        return (0, s.jsx)(s.Fragment, {
          children: V.map((t) => {
            let e = m(t),
              n = (!c || !!g) && (x === V || P.includes(e));
            return (0, s.jsx)(
              d,
              {
                isPresent: n,
    ...
    4458: (t, e, i) => {
      ...
      function S(t, e) {
        let i = !1,
          ...
          p = () => {
            let r = P.useManualTiming ? n.timestamp : performance.now();
            ((i = !1),
              (n.delta = s
                ? 1e3 / 60
      ...
      let C = {
        now: () => (
          void 0 === s &&
            C.set(
              V.isProcessing || P.useManualTiming
                ? V.timestamp
                : performance.now(),
            ),
          s
      ...
      class k {
        ...
        add(t) {
          return (E(this.subscriptions, t), () => R(this.subscriptions, t));
        }
        notify(t, e, i) {
      ...
      let U = (t) => t.replace(/([a-z])([A-Z])/gu, "$1-$2").toLowerCase(),
        N = "data-" + U("framerAppearId");
      var $ = i(3881);
      let W = { current: !1 },
        z = (t, e, i) =>
          (((1 - 3 * i + 3 * e) * t + (3 * i - 6 * e)) * t + 3 * e) * t;
      function X(t, e, i, s) {
        if (t === e && i === s) return w.Z;
        let n = (e) =>
          (function (t, e, i, s, n) {
            let r, o;
            let a = 0;
            do (r = z((o = e + (i - e) / 2), s, n) - t) > 0 ? (i = o) : (e = o);
      ...
      let tE = (t) => ("number" == typeof t ? 0 : t),
        ...
        tk = new Set(["brightness", "contrast", "saturate", "opacity"]);
      function tj(t) {
      ...
      let t$ = new Set(["auto", "none", "0"]),
        tW = (t) => t === ti || t === tg,
        tz = (t, e) => parseFloat(t.split(", ")[e]),
        tX =
          (t, e) =>
          (i, { transform: s }) => {
            if ("none" === s || !s) return 0;
            let n = s.match(/^matrix3d\((.+)\)$/u);
            if (n) return tz(n[1], e);
            {
      ...
      let t1 = (t) => /^-?(?:\d+(?:\.\d+)?|\.\d+)$/u.test(t),
        t5 = (t) => (e) => "string" == typeof e && e.startsWith(t),
        t2 = t5("--"),
        t3 = t5("var(--"),
        t9 = (t) => !!t3(t) && t4.test(t.split("/*")[0].trim()),
        t4 =
          /var\(--(?:[\w-]+\s*|[\w-]+\s*,(?:\s*[^)(\s]|\s*\((?:[^)(]|\([^)(]*\))*\))+\s*)\)$/iu,
        t8 = /^var\(--(?:([\w-]+)|([\w-]+), ?([a-zA-Z\d ()%#.,-]+))\)/u,
        t7 = (t) => (e) => e.test(t),
        t6 = [
          ti,
          tg,
      ...
      function eC(t = eb.visualDuration, e = eb.bounce) {
        ...
        let s =
          ...
          P = 5 > Math.abs(y);
        if (
          (n || (n = P ? eb.restSpeed.granular : eb.restSpeed.default),
          r || (r = P ? eb.restDelta.granular : eb.restDelta.default),
          g < 1)
        ) {
          let t = eA(x, g);
          i = (e) =>
        ...
        let n = eF(s) ? s.map(eB) : eB(s),
          ...
          o = (function (t, e, { clamp: i = !0, ease: s, mixer: n } = {}) {
            ...
            let a = (function (t, e, i) {
                ...
                for (let i = 0; i < r; i++) {
                  let r = n(t[i], t[i + 1]);
                  (e && (r = ef(Array.isArray(e) ? e[i] || w.Z : e, r)),
                    s.push(r));
                }
                return s;
              })(e, s, n),
      ...
      let eU = (t) => {
        ...
        eN = { decay: eE, inertia: eE, tween: eI, keyframes: eI, spring: eC },
        e$ = (t) => t / 100;
      class eW extends er {
        constructor(t) {
          (super(t),
        ...
        tick(t, e = !1) {
          ...
          return (
            T && void 0 !== s && (P.value = en(a, this.options, s)),
            f && f(P.value),
            T && this.finish(),
            P
          );
      ...
      let ez = new Set(["opacity", "clipPath", "filter", "transform"]),
        ...
        eY = { anticipate: _, backInOut: q, circInOut: Q };
      class eH extends er {
        constructor(t) {
          super(t);
          let {
        ...
        initPlayback(t, e) {
          ...
          if (
            ("string" == typeof r && (0, m.Vc)() && r in eY && (r = eY[r]),
            (i = this.options),
      ...
      let eK = { type: "spring", stiffness: 500, damping: 25, restSpeed: 10 },
        ...
        eJ =
          ...
          (o) => {
            ...
            return !r && eH.supports(u) ? new eH(u) : new eW(u);
          };
      ...
      class iz {
        ...
        updateAxis(t, e, i) {
          ...
          if (!i || !iX(t, s, this.currentDirection)) return;
          ...
          (e && ic(e)
            ...
            : e && s
              ? (this.constraints = (function (
                  ...
                  return { x: iP(t.x, i, n), y: iP(t.y, e, s) };
                })(s.layoutBox, e))
              : (this.constraints = !1),
        ...
        resolveRefConstraints() {
          ...
          let r = (function (t, e, i) {
            ...
            o = { x: iw((t = n.layout.layoutBox).x, r.x), y: iw(t.y, r.y) };
          if (i) {
            let t = i(
              (function ({ x: t, y: e }) {
      ...
      let i1 = {
        ...
        i5 = {},
        { schedule: i2, cancel: i3 } = S(queueMicrotask, !1);
      ...
      function sR({
        ...
        return class {
          ...
          addEventListener(t, e) {
            return (
              this.eventHandlers.has(t) || this.eventHandlers.set(t, new k()),
                ...
                this.addEventListener(
                  ...
                  ({
                    ...
                    let n =
                      ...
                      l = !this.targetLayout || !sw(this.targetLayout, s) || i,
                      h = !e && i;
                    if (
          ...
          startUpdate() {
            !this.isUpdateBlocked() &&
              ((this.isUpdating = !0),
              this.nodes && this.nodes.forEach(sz),
              this.animationId++);
          }
          ...
          update() {
            ...
            (this.isUpdating || this.nodes.forEach(sI),
              (this.isUpdating = !1),
          ...
          didUpdate() {
            this.updateScheduled ||
              ((this.updateScheduled = !0), i2.read(this.scheduleUpdate));
          }
          clearAllSnapshots() {
            (this.nodes.forEach(sB), this.sharedNodes.forEach(sX));
          }
          ...
          applyTransform(t, e = !1) {
            ...
            for (let t = 0; t < this.path.length; t++) {
              ...
              (!e &&
                ...
                s.scroll &&
                s !== s.root &&
                iU(i, { x: -s.scroll.offset.x, y: -s.scroll.offset.y }),
                ik(s.latestValues) && iU(i, s.latestValues));
            }
            return (ik(this.latestValues) && iU(i, this.latestValues), i);
          }
          removeTransform(t) {
            let e = iM();
            su(e, t);
            for (let t = 0; t < this.path.length; t++) {
              ...
              iR(i.latestValues) && i.updateSnapshot();
              let s = iM();
            ...
            return (ik(this.latestValues) && sv(e, this.latestValues), e);
          }
          setTargetDelta(t) {
            ((this.targetDelta = t),
                ...
                for (let a = 0; a < o; a++) {
                  ...
                  (!o ||
                    ...
                    (s &&
                      ...
                      n.scroll &&
                      n !== n.root &&
                      iU(t, { x: -n.scroll.offset.x, y: -n.scroll.offset.y }),
                    r && ((e.x *= r.x.scale), (e.y *= r.y.scale), iB(t, r)),
                    s && ik(n.latestValues) && iU(t, n.latestValues));
                }
      ...
      let sZ = { duration: 0.45, ease: [0.4, 0, 0.1, 1] },
        ...
        s_ = sq("applewebkit/") && !sq("chrome/") ? Math.round : w.Z;
      function sG(t) {
        ...
        mount() {
          ...
          t &&
            (this.unmount = (0, m.Mr)(
              t,
              (t) => (
                s2(this.node, t, "Start"),
                (t) => s2(this.node, t, "End")
              ),
            ));
        }
        unmount() {}
        ...
        mount() {
          ...
          t &&
            (this.unmount = (0, m.OD)(
              t,
              (t) => (
                s4(this.node, t, "Start"),
                (t, { success: e }) => s4(this.node, t, e ? "End" : "Cancel")
              ),
      ...
      let nx = (t) => (e, i) => {
        ...
        nP = (t, e) => (e && "number" == typeof t ? e.transform(t) : t),
        nw = {
          x: "translateX",
          y: "translateY",
          z: "translateZ",
      ...
      function nR(t, { style: e, vars: i }, s, n) {
      ...
      function nj(t, e, i, s) {
        for (let i in (nR(t, e, void 0, s), e.attrs))
          t.setAttribute(nk.has(i) ? i : U(i), e.attrs[i]);
      }
      function nF(t, { layout: e, layoutId: i }) {
        return (
          v.has(t) ||
          t.startsWith("origin") ||
          ((e || void 0 !== i) && (!!i5[t] || "opacity" === t))
        );
      }
      function nL(t, e, i) {
        var s;
      ...
      try {
        !(function (t) {
          t && (nz = (e) => (e.startsWith("on") ? !nW(e) : t(e)));
      ...
      class n_ {
        ...
        mount(t) {
          ((this.current = t),
            ...
            nY.current ||
              (function () {
                if (((nY.current = !0), nu.j)) {
                  if (window.matchMedia) {
                    let t = window.matchMedia("(prefers-reduced-motion)"),
                      e = () => (nX.current = t.matches);
                    (t.addListener(e), e());
                  } else nX.current = !1;
                }
              })(),
            (this.shouldReduceMotion =
              ...
              ("always" === this.reducedMotionConfig || nX.current)),
            this.parent && this.parent.children.add(this),
        ...
        readValueFromInstance(t, e) {
          ...
          }
          {
            let i = window.getComputedStyle(t),
              s = (t2(e) ? i.getPropertyValue(e) : i[e]) || 0;
      ...
      class nQ extends nG {
        ...
        readValueFromInstance(t, e) {
          ...
          return ((e = nk.has(e) ? e : U(e)), t.getAttribute(e));
        }
        scrapeMotionValuesFromProps(t, e, i) {
          return nB(t, e, i);
        }
      ...
      let n0 = (function (t) {
        ...
        ((c = {
          ...
          hover: { Feature: s3 },
          pan: { Feature: iK },
          drag: { Feature: iY, ProjectionNode: s5, MeasureLayout: i4 },
          layout: { ProjectionNode: s5, MeasureLayout: i4 },
        }),
        (p = (t, e) =>
          ng(t)
            ? new nQ(e)
    ...
    5429: (t, e, i) => {
      i.d(e, { L: () => n });
      var s = i(7810);
      let n = i(4184).j ? s.useLayoutEffect : s.useEffect;
    },
  },
]);
