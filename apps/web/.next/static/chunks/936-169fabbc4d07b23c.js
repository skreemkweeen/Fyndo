...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [936],
  {
    ...
    4936: (e, t, r) => {
      ...
      let S = a.default.forwardRef(function (e, t) {
        let r, n;
        let {
          href: s,
          as: E,
        ...
        let M = a.default.useContext(f.RouterContext),
          ...
          { href: F, as: X } = a.default.useMemo(() => {
            if (!M) {
              let e = y(s);
              return { href: e, as: E ? y(E) : e };
            }
            let [e, t] = (0, i.resolveHref)(M, s, !0);
            return { href: e, as: E ? (0, i.resolveHref)(M, E) : t || e };
          }, [M, s, E]),
          W = a.default.useRef(F),
          G = a.default.useRef(X);
        ...
        }, [X, F, Y, T, U, null == M ? void 0 : M.locale, L, D, k]);
        let q = {
          ref: z,
          onClick(e) {
        ...
        if ((0, l.isAbsoluteUrl)(X)) q.href = X;
        else if (!x || b || ("a" === n.type && !("href" in n.props))) {
          ...
          q.href =
            t ||
            (0, _.addBasePath)(
              (0, c.addLocale)(X, e, null == M ? void 0 : M.defaultLocale),
            );
        }
        return x
    ...
    6783: (e, t) => {
      ...
      let r = "nxtP",
        ...
        w = "private-next-rsc-server-reference",
    ...
    5861: (e, t, r) => {
      ...
      let n = r(9042)._(r(7810)).default.createContext(null);
    },
    8651: (e, t, r) => {
      (Object.defineProperty(t, "__esModule", { value: !0 }),
        (function (e, t) {
          ...
          parameterizedRoute: t
            .map((e) => {
              let t = o.INTERCEPTION_ROUTE_MARKERS.find((t) => e.startsWith(t)),
                i = e.match(u);
              if (t && i) {
                let { key: e, optional: o, repeat: u } = l(i[1]);
                return (
