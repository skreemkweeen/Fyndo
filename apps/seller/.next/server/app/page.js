(() => {
  ...
  ((t.id = 931),
    ...
    (t.modules = {
              ...
              children: [
                ...
                {},
                {
                  page: [
                    ...
                    "C:\\Users\\rogsh\\Documents\\Antigravity\\Fyndo\\apps\\seller\\app\\page.tsx",
                  ],
                },
              ],
            },
      ...
      5986: () => {},
      6825: (t, e, i) => {
        Promise.resolve().then(i.bind(i, 8929));
      },
      2372: (t, e, i) => {
      ...
      8929: (t, e, i) => {
        ...
        let T = (t) => Array.isArray(t) && "number" == typeof t[0],
          ...
          j = (t, e, i = 10) => {
            ...
            for (let e = 0; e < n; e++) s += t(M(0, n - 1, e)) + ", ";
            return `linear(${s.substring(0, s.length - 2)})`;
          },
          V = ([t, e, i, s]) => `cubic-bezier(${t}, ${e}, ${i}, ${s})`,
          E = {
            linear: "linear",
            ease: "ease",
            easeIn: "ease-in",
        ...
        function Z(t, e) {
          let i = !1,
            ...
            p = () => {
              let r = _.useManualTiming ? n.timestamp : performance.now();
              ((i = !1),
                (n.delta = s
                  ? 1e3 / 60
        ...
        let ts = {
          now: () => (
            void 0 === s &&
              ts.set(
                tt.isProcessing || _.useManualTiming
                  ? tt.timestamp
                  : performance.now(),
              ),
            s
        ...
        let ty = (t) => (e) =>
          ...
          tM = ty(tA),
          tj = (t) => /^0[^.\s]+$/u.test(t),
          tV = (t, e, i) => (i > e ? e : i < t ? t : i),
          tE = {
            test: (t) => "number" == typeof t,
            parse: parseFloat,
            transform: (t) => t,
          },
          tk = { ...tE, transform: (t) => tV(0, 1, t) },
          tD = { ...tE, default: 1 },
          ...
          tF = (t, e) => (i) =>
            !!(
              ("string" == typeof i && tL.test(i) && i.startsWith(t)) ||
          ...
          tB = (t) => tV(0, 255, t),
          tO = { ...tE, transform: (t) => Math.round(tB(t)) },
          tU = {
            test: tF("rgb", "red"),
          ...
          t_ = {
            test: (t) => tU.test(t) || tI.test(t) || tK.test(t),
            parse: (t) =>
              tU.test(t) ? tU.parse(t) : tK.test(t) ? tK.parse(t) : tI.parse(t),
            transform: (t) =>
              "string" == typeof t
                ? t
          ...
          let e = t.toString(),
            ...
            o = e
              .replace(
                ...
                (t) => (
                  t_.test(t)
                    ? (s.color.push(r), n.push(tJ), i.push(t_.parse(t)))
                    : t.startsWith("var(")
                      ? (s.var.push(r), n.push("var"), i.push(t))
                      : (s.number.push(r), n.push(tZ), i.push(parseFloat(t))),
                  ++r,
                  "${}"
                ),
              )
        ...
        function e1(t = eG.visualDuration, e = eG.bounce) {
          let i;
          let s =
              "object" != typeof t
            ...
            l = { done: !1, value: o },
            {
              ...
              let e = {
                velocity: eG.velocity,
                stiffness: eG.stiffness,
                damping: eG.damping,
                mass: eG.mass,
              ...
              if (!e0(t, eQ) && e0(t, eJ)) {
                if (t.visualDuration) {
                  let i = (2 * Math.PI) / (1.2 * t.visualDuration),
                    s = i * i,
                    n = 2 * tV(0.05, 1, 1 - (t.bounce || 0)) * Math.sqrt(s);
                  e = { ...e, mass: eG.mass, stiffness: s, damping: n };
                } else {
                  let i = (function ({
                    duration: t = eG.duration,
                    bounce: e = eG.bounce,
                    velocity: i = eG.velocity,
                    mass: s = eG.mass,
                  }) {
                    let n, r;
                    z(
                    ...
                    let o = 1 - e;
                    ((o = tV(eG.minDamping, eG.maxDamping, o)),
                      (t = tV(eG.minDuration, eG.maxDuration, W(t))),
                      o < 1
                        ? ((n = (e) => {
                            let s = e * o,
                              n = s * t;
                            return 0.001 - ((s - i) / eZ(e, o)) * Math.exp(-n);
                          }),
                          (r = (e) => {
                            let s = e * o * t,
                  ...
                  (e = { ...e, ...i, mass: eG.mass }).isResolvedFromDuration =
                    !0;
                }
              }
              return e;
            ...
            x = 5 > Math.abs(g);
          if (
            (n || (n = x ? eG.restSpeed.granular : eG.restSpeed.default),
            r || (r = x ? eG.restDelta.granular : eG.restDelta.default),
            v < 1)
          ) {
            let t = eZ(y, v);
            i = (e) =>
        ...
        let it = (t) => {
          ...
          ie = { decay: e2, inertia: e2, tween: e8, keyframes: e8, spring: e1 },
          ii = (t) => t / 100;
        class is extends eD {
          constructor(t) {
            (super(t),
        ...
        let ir = new Set(["opacity", "clipPath", "filter", "transform"]),
          ...
          ia = { anticipate: tT, backInOut: tP, circInOut: tM };
        class il extends eD {
          constructor(t) {
            super(t);
            let {
        ...
        let ik = (t) => (e) => L(e) && t(e, iE(e));
        function iD(t, e, i, s) {
          return iV(t, e, ik(i), s);
        }
          ...
          constructor(
            ...
            if (
              ...
              (this.updatePoint = () => {
                ...
                let t = iN(this.lastMoveEventInfo, this.history),
            ...
            let r = iL(iE(t), this.transformPagePoint),
              { point: o } = r,
              { timestamp: a } = tt;
            this.history = [{ ...o, timestamp: a }];
            let { onSessionStart: l } = e;
            (l && l(t, iN(r, this.history)),
        ...
        class sn {
            ...
            (e && iO(e)
              ...
              : e && s
                ? (this.constraints = (function (
                    ...
                    return { x: iq(t.x, i, n), y: iq(t.y, e, s) };
                  })(s.layoutBox, e))
                : (this.constraints = !1),
          ...
          resolveRefConstraints() {
            ...
            let r = (function (t, e, i) {
                let s = se(t, i),
                  { scroll: n } = e;
                return (n && (i7(s.x, n.offset.x), i7(s.y, n.offset.y)), s);
              })(s, n.root, this.visualElement.getTransformPagePoint()),
              o = { x: iY((t = n.layout.layoutBox).x, r.x), y: iY(t.y, r.y) };
            if (i) {
              let t = i(
                (function ({ x: t, y: e }) {
                  return {
            ...
            iQ((t) => {
              ...
              if (e && !1 !== this.constraints) {
                ...
                s[t] = (function (t, e) {
                  ...
                  return (
                    n > s
                      ? (i = M(e.min, e.max - s, t.min))
                      : s > n && (i = M(t.min, t.max - n, e.min)),
                    tV(0, 1, i)
                  );
        ...
        let sf = {
          ...
          sv = {},
          { schedule: sg, cancel: sy } = Z(queueMicrotask, !1);
        ...
        let sS = ["TopLeft", "TopRight", "BottomLeft", "BottomRight"],
          sM = sS.length,
          sj = (t) => ("string" == typeof t ? parseFloat(t) : t),
          sV = (t) => "number" == typeof t || tH.test(t);
        function sE(t, e) {
        ...
        let sk = sC(0, 0.5, tS),
          sD = sC(0.5, 0.95, z);
        function sC(t, e, i) {
          return (s) => (s < t ? 0 : s > e ? 1 : i(M(t, e, s)));
        }
        function sR(t, e) {
        ...
        function sB(t, e, [i, s, n], r, o) {
          !(function (t, e = 0, i = 1, s = 0.5, n, r = t, o = t) {
            ...
            (t === r && (a -= e),
              (t.min = sN(t.min, e, i, a, n)),
              (t.max = sN(t.max, e, i, a, n)));
        ...
        function s1({
          ...
          return class {
                  ...
                  this.addEventListener(
                    ...
                    ({
                      ...
                      let n =
                        ...
                        l =
                          !this.targetLayout || !sq(this.targetLayout, s) || i,
                        h = !e && i;
                      if (
            ...
            update() {
              ...
              (this.isUpdating || this.nodes.forEach(s7),
                (this.isUpdating = !1),
                ...
                this.clearAllSnapshots());
              let t = ts.now();
              ((tt.delta = tV(0, 1e3 / 60, t - tt.timestamp)),
                (tt.timestamp = t),
                (tt.isProcessing = !0),
            ...
            measurePageBox() {
              ...
              if (!(
                ...
                t && (i7(i.x, t.offset.x), i7(i.y, t.offset.y));
              }
              return i;
            }
            ...
            applyTransform(t, e = !1) {
              ...
              for (let t = 0; t < this.path.length; t++) {
                ...
                (!e &&
                  ...
                  i3(s.latestValues) && st(i, s.latestValues));
              }
              return (i3(this.latestValues) && st(i, this.latestValues), i);
            }
            removeTransform(t) {
              let e = iJ();
              sL(e, t);
              for (let t = 0; t < this.path.length; t++) {
                let i = this.path[t];
                if (!i.instance || !i3(i.latestValues)) continue;
              ...
              return (i3(this.latestValues) && sI(e, this.latestValues), e);
            }
            setTargetDelta(t) {
              ((this.targetDelta = t),
                ...
                if (o) {
                  ...
                  for (let a = 0; a < o; a++) {
                    ...
                    (!o ||
                      ...
                      s && i3(n.latestValues) && st(t, n.latestValues));
                  }
            ...
            createProjectionDeltas() {
              ((this.prevProjectionDelta = iG()),
                (this.projectionDelta = iG()),
                (this.projectionDeltaWithTransform = iG()));
            }
            ...
            registerSharedNode(t, e) {
              (this.sharedNodes.has(t) || this.sharedNodes.set(t, new sK()),
            ...
            resetSkewAndRotation() {
              ...
              for (let e = 0; e < sZ.length; e++)
                (s0(`rotate${sZ[e]}`, t, s, this.animationValues),
                  s0(`skew${sZ[e]}`, t, s, this.animationValues));
        ...
        function nc(t, e, i) {
          return (
            "position" === t ||
            ("preserve-aspect" === t && !(0.2 >= Math.abs(sY(e) - sY(i))))
          );
        }
        function np(t) {
          var e;
        ...
        let nV = (0, sh.createContext)({ strict: !1 }),
          nE = (0, sh.createContext)({
        ...
        let nL = "undefined" != typeof window,
          ...
          nN = {};
        for (let t in nF)
          nN[t] = { isEnabled: (e) => nF[t].some((t) => !!e[t]) };
        let nB = Symbol.for("motionComponentSymbol"),
          nO = nL ? sh.useLayoutEffect : sh.useEffect,
          nU = [
            "animate",
            "circle",
            "defs",
                ...
                o &&
                  J.read(() => {
                    ((function (t, e) {
                      ...
                      J.render(() => {
                        (n_(s, n, nJ(i.tagName), t.transformTemplate),
                          n1(i, s));
                      }));
                  });
              },
        ...
        class rl {
          ...
          readValue(t, e) {
            ...
            return (
              null != s &&
                ("string" == typeof s && (eg(s) || tj(s))
                  ? (s = parseFloat(s))
                  : !rr(s) && t5.test(e) && (s = es(t, e)),
        ...
        class rh extends rl {
          constructor() {
            (super(...arguments), (this.KeyframeResolver = ej));
          }
            ...
            return (function ({
              ...
              function l(t, r) {
                ...
                let h = {
                  ...
                  p = s(t, d);
                if (!d && nL) {
                  (0, sh.useContext)(nV).strict;
                  let t = (function (t) {
                    let { drag: e, layout: i } = nN;
                    if (!e && !i) return {};
                    let s = { ...e, ...i };
                    return {
                      MeasureLayout:
                  ...
                  ((l = t.MeasureLayout),
                    (c.visualElement = (function (t, e, i, s, n) {
                      ...
                      let { visualElement: a } = (0, sh.useContext)(nk),
                        l = (0, sh.useContext)(nV),
                        h = (0, sh.useContext)(su),
                        u = (0, sh.useContext)(nE).reducedMotion,
                        d = (0, sh.useRef)(null);
                      ((s = s || l.renderer),
                        !d.current &&
                          s &&
                      ...
                      nI(e)
                        ? function (t, e, i, s) {
                            let n = (0, sh.useMemo)(() => {
                              let i = nZ();
                              return (
                                n_(i, e, nJ(s), t.transformTemplate),
        ...
        var rp = i(247);
        let rm = (0, rp.Z)("ArrowUpRight", [
            ["path", { d: "M7 7h10v10", key: "1tivn9" }],
            ["path", { d: "M7 17 17 7", key: "1vkiza" }],
          ]),
          rf = (0, rp.Z)("DollarSign", [
                  ...
                  (0, o.jsxs)(rc.div, {
                    ...
                    children: [
                      ...
                      (0, o.jsx)("div", {
                        ...
                        children: [40, 70, 45, 90, 65, 80, 100].map((t, e) =>
                          (0, o.jsx)(
                            rc.div,
                            {
                              initial: { height: 0 },
                  ...
                  (0, o.jsxs)(rc.div, {
                    ...
                    children: [
                      ...
                      (0, o.jsx)("div", {
                        ...
                        children: (0, o.jsx)(rg, { className: "w-5 h-5" }),
                      }),
                      (0, o.jsxs)("div", {
                        children: [
                          (0, o.jsx)("p", {
                          ...
                          (0, o.jsx)("div", {
                            ...
                            children: [1, 2, 3, 4].map((t) =>
                              (0, o.jsx)(
                                "div",
                                {
                                  className: `w-10 h-10 rounded-full border-2 border-neutral-900 bg-neutral-800 flex items-center justify-center z-[${5 - t}]`,
                                  children: (0, o.jsx)(ry.Z, {
      ...
      626: (t, e, i) => {
        "use strict";
        (i.r(e), i.d(e, { default: () => r, metadata: () => n }));
        var s = i(2241);
        i(463);
        let n = {
            ...
            try {
              ...
              let t = (
                await (0, n.createProxy)(
                  String.raw`C:\Users\rogsh\Documents\Antigravity\Fyndo\apps\seller\app\page.tsx`,
                )
              ).default;
              s();
            } catch (t) {
