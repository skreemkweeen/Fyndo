                ...
                ((this._internalState = e
                  ...
                  .reduce(function (e, t) {
                    ...
                    if (-1 !== n) {
                      ...
                      eI.test(o) && eL.test(a) && !ek.test(a) && e.set(o, a);
                    }
                    return e;
                  }, new Map())),
          ...
          let w = (0, o.getTracer)().trace(
            ...
            async () => {
              ...
              let N = m("headers"),
                ...
                U =
                  (k && !S.isPrerendering) ||
                  ((D || I) && L && 0 === L.revalidate);
              if (k && void 0 !== O && "prerender" === O.type)
                return (
                  R && (R.endRead(), (R = null)),
                    ...
                    ? "default-no-store" === T
                      ...
                      : M
                        ...
                        : U
                          ? ((g = 0), (j = "auto no cache"))
                          : ((j = "auto cache"),
                            (g = L ? L.revalidate : a.INFINITE_CACHE))
                    : ((g = a.INFINITE_CACHE),
                      (j = "fetchCache = default-cache"))
                  : j || (j = `revalidate: ${g}`),
                !(S.forceStatic && 0 === g) && !U && L && g < L.revalidate)
              ) {
                if (0 === g) {
