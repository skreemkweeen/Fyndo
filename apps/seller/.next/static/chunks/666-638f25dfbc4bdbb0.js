    ...
    2588: (t, e, i) => {
      ...
      let w = (t) => Array.isArray(t) && "number" == typeof t[0],
        ...
        S = (t, e, i = 10) => {
          ...
          for (let e = 0; e < n; e++) s += t(b(0, n - 1, e)) + ", ";
          return `linear(${s.substring(0, s.length - 2)})`;
        },
        A = ([t, e, i, s]) => `cubic-bezier(${t}, ${e}, ${i}, ${s})`,
        M = {
          linear: "linear",
          ease: "ease",
          easeIn: "ease-in",
      ...
      function k(t) {
        return (e) => {
          "touch" === e.pointerType || V.x || V.y || t(e);
        };
      }
      ...
      let U = (t) => 1e3 * t,
        ...
        Y = (t) => (r(t) ? t[t.length - 1] || 0 : t),
        X = { skipAnimations: !1, useManualTiming: !1 },
        K = [
          "read",
          "resolveKeyframes",
          "update",
      ...
      function q(t, e) {
        let i = !1,
          ...
          p = () => {
            let r = X.useManualTiming ? n.timestamp : performance.now();
            ((i = !1),
              (n.delta = s
                ? 1e3 / 60
      ...
      let tt = {
        now: () => (
          void 0 === s &&
            tt.set(
              _.isProcessing || X.useManualTiming
                ? _.timestamp
                : performance.now(),
            ),
          s
      ...
      class ts {
        ...
        add(t) {
          return (te(this.subscriptions, t), () => ti(this.subscriptions, t));
        }
        notify(t, e, i) {
      ...
      function th(t, e) {
        ...
        if (tl(i) && i.add) return i.add(e);
      }
      let tu = (t) => t.replace(/([a-z])([A-Z])/gu, "$1-$2").toLowerCase(),
        td = "data-" + tu("framerAppearId"),
        tc = { current: !1 },
        tp = (t, e, i) =>
      ...
      function tm(t, e, i, s) {
        ...
        let n = (e) =>
          (function (t, e, i, s, n) {
            ...
            let a = 0;
            do
              (r = tp((o = e + (i - e) / 2), s, n) - t) > 0 ? (i = o) : (e = o);
            while (Math.abs(r) > 1e-7 && ++a < 12);
            return o;
          })(e, 0, 1, t, i);
        return (t) => (0 === t || 1 === t ? t : tp(n(t), e, s));
      }
      let tf = (t) => (e) =>
          e <= 0.5 ? t(2 * e) / 2 : (2 - t(2 * (1 - e))) / 2,
        tv = (t) => (e) => 1 - t(1 - e),
        tg = tm(0.33, 1.53, 0.69, 0.99),
        ty = tv(tg),
        tx = tf(ty),
        tw = (t) =>
          (t *= 2) < 1 ? 0.5 * ty(t) : 0.5 * (2 - Math.pow(2, -10 * (t - 1))),
        ...
        tj = (t) => tA(0, 255, t),
        tF = { ...tM, transform: (t) => Math.round(tj(t)) },
        tB = {
          test: tR("rgb", "red"),
        ...
        tX = {
          test: (t) => tB.test(t) || tO.test(t) || tY.test(t),
          parse: (t) =>
            tB.test(t) ? tB.parse(t) : tY.test(t) ? tY.parse(t) : tO.parse(t),
          transform: (t) =>
            "string" == typeof t
              ? t
        ...
        let e = t.toString(),
          ...
          o = e
            .replace(
              ...
              (t) => (
                tX.test(t)
                  ? (s.color.push(r), n.push(tZ), i.push(tX.parse(t)))
                  : t.startsWith("var(")
                    ? (s.var.push(r), n.push("var"), i.push(t))
                    : (s.number.push(r), n.push(tq), i.push(parseFloat(t))),
                ++r,
                "${}"
              ),
            )
        ...
        t1 = {
          test: function (t) {
            ...
            return (
              isNaN(t) &&
              "string" == typeof t &&
              ((null === (e = t.match(tD)) || void 0 === e
                ? void 0
                : e.length) || 0) +
                ((null === (i = t.match(tK)) || void 0 === i
                  ? void 0
                  : i.length) || 0) >
                0
            );
          ...
          parse: tJ,
          createTransformer: tQ,
          getAnimatableNone: function (t) {
            let e = tJ(t);
            return tQ(t)(e.map(t0));
          },
        },
        t2 = new Set(["brightness", "contrast", "saturate", "opacity"]);
      function t5(t) {
      ...
      let ee = new Set(["auto", "none", "0"]),
        ei = (t) => t === tM || t === t$,
        es = (t, e) => parseFloat(t.split(", ")[e]),
        en =
          (t, e) =>
          (i, { transform: s }) => {
            if ("none" === s || !s) return 0;
            let n = s.match(/^matrix3d\((.+)\)$/u);
            if (n) return es(n[1], e);
            {
      ...
      function ed() {
        ...
        ((eu = !1), (eh = !1), el.forEach((t) => t.complete()), el.clear());
      }
      function ec() {
        el.forEach((t) => {
      ...
      class ep {
        ...
        scheduleResolve() {
          ((this.isScheduled = !0),
            this.isAsync
              ? (el.add(this),
                eh || ((eh = !0), Z.read(ec), Z.resolveKeyframes(ed)))
      ...
      let em = (t) => /^-?(?:\d+(?:\.\d+)?|\.\d+)$/u.test(t),
        ...
        ev = ef("--"),
        eg = ef("var(--"),
        ey = (t) => !!eg(t) && ex.test(t.split("/*")[0].trim()),
        ex =
      ...
      class eS extends ep {
        ...
        readKeyframes() {
          ...
          for (let i = 0; i < t.length; i++) {
            let s = t[i];
            if ("string" == typeof s && ey((s = s.trim()))) {
              let n = (function t(e, i, s = 1) {
                ...
                return ey(r) ? t(r, i, s + 1) : r;
              })(s, e.current);
              (void 0 !== n && (t[i] = n),
                i === t.length - 1 && (this.finalKeyframe = s));
            }
          }
          if ((this.resolveNoneKeyframes(), !z.has(i) || 2 !== t.length))
            return;
          let [s, n] = t,
            r = eb(s),
            o = eb(n);
        ...
        resolveNoneKeyframes() {
          ...
          for (let e = 0; e < t.length; e++) {
            ...
            ("number" == typeof (s = t[e])
              ? 0 === s
              : null === s || "none" === s || "0" === s || tS(s)) && i.push(e);
          }
          i.length &&
            (function (t, e, i) {
              let s,
              ...
              if (s && i) for (let n of e) t[n] = et(i, s);
            })(t, i, e);
        }
        measureInitialState() {
      ...
      let eA = (t, e) =>
        ...
        eM = (t) => null !== t;
      function eV(t, { repeat: e, repeatType: i = "loop" }, s) {
        let n = t.filter(eM),
      ...
      class eE {
        ...
        get resolved() {
          return (
            this._resolved || this.hasAttemptedResolve || (ec(), ed()),
            this._resolved
          );
        }
      ...
      let eB = (t, e) => {
          ...
          let n = { ...i };
          return (t) => (
            (n.red = eR(i.red, s.red, t)),
            (n.green = eR(i.green, s.green, t)),
            (n.blue = eR(i.blue, s.blue, t)),
            (n.alpha = ek(i.alpha, s.alpha, t)),
            tB.transform(n)
          );
        },
        eO = (t, e) => (i) => e(t(i)),
      ...
      function eJ(t = eK.visualDuration, e = eK.bounce) {
        let i;
        let s =
            "object" != typeof t
            ...
            if (!e_(t, eG) && e_(t, eZ)) {
              if (t.visualDuration) {
                let i = (2 * Math.PI) / (1.2 * t.visualDuration),
                  s = i * i,
                  n = 2 * tA(0.05, 1, 1 - (t.bounce || 0)) * Math.sqrt(s);
                ...
                let i = (function ({
                  ...
                  ((o = tA(eK.minDamping, eK.maxDamping, o)),
                    (t = tA(eK.minDuration, eK.maxDuration, I(t))),
                    o < 1
                      ? ((n = (e) => {
                          let s = e * o,
                            n = s * t;
                          return 0.001 - ((s - i) / eq(e, o)) * Math.exp(-n);
                        }),
                        (r = (e) => {
                          let s = e * o * t,
                ...
                (e = { ...e, ...i, mass: eK.mass }).isResolvedFromDuration = !0;
              }
            }
            return e;
          ...
          w = 5 > Math.abs(y);
        if (
          (n || (n = w ? eK.restSpeed.granular : eK.restSpeed.default),
          r || (r = w ? eK.restDelta.granular : eK.restDelta.default),
          v < 1)
        ) {
          let t = eq(x, v);
          i = (e) =>
            a -
            Math.exp(-v * x * e) *
              (((f + v * x * y) / t) * Math.sin(t * e) + y * Math.cos(t * e));
        } else if (1 === v)
          i = (t) => a - Math.exp(-x * t) * (y + (f + x * y) * t);
        else {
          ...
          i = (e) => {
            ...
            return (
              a -
              (i * ((f + v * x * y) * Math.sinh(s) + t * y * Math.cosh(s))) / t
            );
          };
        }
        let P = {
      ...
      let e0 = tm(0.42, 0, 1, 1),
        ...
        e9 = (t) => {
          ...
          return "string" == typeof t
            ? (N(void 0 !== e3[t], `Invalid easing type '${t}'`), e3[t])
            : t;
        };
      function e4({
        duration: t = 300,
        ...
        let n = e5(s) ? s.map(e9) : e9(s),
          ...
          o = (function (t, e, { clamp: i = !0, ease: s, mixer: n } = {}) {
            ...
            let a = (function (t, e, i) {
                ...
                for (let i = 0; i < r; i++) {
                  let r = n(t[i], t[i + 1]);
                  (e && (r = eU(Array.isArray(e) ? e[i] || N : e, r)),
                    s.push(r));
                }
                return s;
              })(e, s, n),
            ...
            e,
            {
              ease: Array.isArray(n)
                ? n
                : e.map(() => n || e2).splice(0, e.length - 1),
            },
          );
        return {
      ...
      let e7 = (t) => {
          ...
          return {
            start: () => Z.update(e, !0),
            stop: () => G(e),
            now: () => (_.isProcessing ? _.timestamp : tt.now()),
          };
        },
        e6 = { decay: eQ, inertia: eQ, tween: e4, keyframes: e4, spring: eJ },
        e8 = (t) => t / 100;
      class it extends eE {
        constructor(t) {
          (super(t),
          ...
          let {
            ...
            r = (null == s ? void 0 : s.KeyframeResolver) || ep;
          ((this.resolver = new r(
            n,
        ...
        tick(t, e = !1) {
          ...
          return (
            T && void 0 !== s && (w.value = eV(a, this.options, s)),
            f && f(w.value),
            T && this.finish(),
            w
          );
        ...
        play() {
          ...
          let { driver: t = e7, onPlay: e, startTime: i } = this.options;
      ...
      let ie = new Set(["opacity", "clipPath", "filter", "transform"]),
        ...
        is = { anticipate: tw, backInOut: tx, circInOut: tb };
      class ir extends eE {
        constructor(t) {
          super(t);
          let {
        ...
        initPlayback(t, e) {
          ...
          if (
            ("string" == typeof r && T() && r in is && (r = is[r]),
            y((i = this.options).type) ||
              "spring" === i.type ||
              !(function t(e) {
                return !!(
                  ("function" == typeof e && T()) ||
                  !e ||
                  ("string" == typeof e && (e in M || T())) ||
                  w(e) ||
          ...
          return (
            ...
            this.pendingTimeline
              ? (x(u, this.pendingTimeline), (this.pendingTimeline = void 0))
              : (u.onfinish = () => {
                  let { onComplete: i } = this.options;
                  (a.set(eV(t, this.options, e)),
                    i && i(),
                    this.cancel(),
                    this.resolveFinishedPromise());
                }),
      ...
      let io = { type: "spring", stiffness: 500, damping: 25, restSpeed: 10 },
        ia = (t) => ({
          type: "spring",
          stiffness: 550,
        ...
        id =
          ...
          (o) => {
            ...
            if (
              ...
              (tc.current || X.skipAnimations) &&
                ((d = !0), (u.duration = 0), (u.delay = 0)),
              d && !r && void 0 !== e.get())
            ) {
              let t = eV(u.keyframes, a);
              if (void 0 !== t)
                return (
                  Z.update(() => {
            ...
            return !r && ir.supports(u) ? new ir(u) : new it(u);
          };
      function ic(t, e, { delay: i = 0, transitionOverride: s, type: n } = {}) {
        var r;
        let {
        ...
        for (let e in l) {
          ...
          if (window.MotionHandoffAnimation) {
            let i = t.props[td];
            if (i) {
              let t = window.MotionHandoffAnimation(i, e, Z);
          ...
          (th(t, e),
            s.start(
              id(
                ...
                s,
                n,
                t.shouldReduceMotion && z.has(e) ? { type: !1 } : a,
                t,
                h,
              ),
            ));
      ...
      function ip(t, e, i = {}) {
        ...
        let o = n ? () => Promise.all(ic(t, n, i)) : () => Promise.resolve(),
          a =
                      ...
                      e.map(({ animation: e, options: i }) =>
                        (function (t, e, i = {}) {
                          ...
                          if ((t.notify("AnimationStart", e), Array.isArray(e)))
                            s = Promise.all(e.map((e) => ip(t, e, i)));
                          else if ("string" == typeof e) s = ip(t, e, i);
                          else {
                            let n =
                              "function" == typeof e ? h(t, e, i.custom) : e;
                            s = Promise.all(ic(t, n, i));
                          }
                          return s.then(() => {
                            t.notify("AnimationComplete", e);
                          });
      ...
      function iA(t, e, i, s = { passive: !0 }) {
        return (t.addEventListener(e, i, s), () => t.removeEventListener(e, i));
      }
      function iM(t) {
        return { point: { x: t.pageX, y: t.pageY } };
      }
      let iV = (t) => (e) => C(e) && t(e, iM(e));
      function iE(t, e, i, s) {
        return iA(t, e, iV(i), s);
      }
      ...
      class iD {
        constructor(
          ...
          if (
            ...
            (this.updatePoint = () => {
              ...
              let t = iL(this.lastMoveEventInfo, this.history),
                ...
                i =
                  (function (t, e) {
                    return Math.sqrt(ik(t.x, e.x) ** 2 + ik(t.y, e.y) ** 2);
                  })(t.offset, { x: 0, y: 0 }) >= 3;
              if (!e && !i) return;
              let { point: s } = t,
                { timestamp: n } = _;
          ...
          let r = iC(iM(t), this.transformPagePoint),
            { point: o } = r,
            { timestamp: a } = _;
          ...
          (l && l(t, iL(r, this.history)),
            (this.removeListeners = eU(
              iE(this.contextWindow, "pointermove", this.handlePointerMove),
              iE(this.contextWindow, "pointerup", this.handlePointerUp),
              iE(this.contextWindow, "pointercancel", this.handlePointerUp),
            )));
        }
        updateHandlers(t) {
          this.handlers = t;
        ...
        return {
          ...
          velocity: (function (t, e) {
            ...
            for (
              ...
              i--;
            if (!s) return { x: 0, y: 0 };
            let r = I(n.timestamp - s.timestamp);
      ...
      function iO(t, e, i, s = 0.5) {
        ((t.origin = s),
          (t.originPoint = ek(e.min, e.max, t.origin)),
          (t.scale = iB(i) / iB(e)),
          (t.translate = ek(i.min, i.max, t.origin) - t.originPoint),
      ...
      function iU(t, e, i, s) {
        (iO(t.x, e.x, i.x, s ? s.originX : void 0),
          iO(t.y, e.y, i.y, s ? s.originY : void 0));
      }
      function iI(t, e, i) {
      ...
      let iX = () => ({ translate: 0, scale: 1, origin: 0, originPoint: 0 }),
        iK = () => ({ x: iX(), y: iX() }),
        iq = () => ({ min: 0, max: 0 }),
        iZ = () => ({ x: iq(), y: iq() });
      function iG(t) {
      ...
      function i_({ top: t, left: e, right: i, bottom: s }) {
      ...
      function i5(t, e = 0, i = 1, s, n) {
        ((t.min = i2(t.min, e, i, s, n)), (t.max = i2(t.max, e, i, s, n)));
      }
      ...
      function i4(t, e, i, s, n = 0.5) {
        let r = ek(t.min, t.max, n);
        i5(t, e, i, r, s);
      }
      function i7(t, e) {
        (i4(t.x, e.x, e.scaleX, e.scale, e.originX),
          i4(t.y, e.y, e.scaleY, e.scale, e.originY));
      }
      function i6(t, e) {
        return i_(
          (function (t, e) {
      ...
      class se {
                  ...
                  iG((t) => {
                    ...
                    if (tN.test(e)) {
                      ...
                      if (i && i.layout) {
                        ...
                        s && (e = iB(s) * (parseFloat(e) / 100));
                      }
                    }
                    this.originPoint[t] = e;
                  }),
                  n && Z.postRender(() => n(t, e)),
        ...
        updateAxis(t, e, i) {
          ...
          if (!i || !si(t, s, this.currentDirection)) return;
          ...
          (this.constraints &&
            ...
            (r = (function (t, { min: e, max: i }, s) {
              return (
                void 0 !== e && t < e
                  ? (t = s ? ek(e, t, s.min) : Math.max(t, e))
                  : void 0 !== i &&
                    t > i &&
                    (t = s ? ek(i, t, s.max) : Math.min(t, i)),
                t
              );
        ...
        resolveConstraints() {
          ...
          (e && iF(e)
            ...
            (this.elastic = (function (t = 0.35) {
              return (
                !1 === t ? (t = 0) : !0 === t && (t = 0.35),
                { x: iH(t, "left", "right"), y: iH(t, "top", "bottom") }
              );
            })(i)),
            n !== this.constraints &&
              s &&
        ...
        resolveRefConstraints() {
          ...
          let r = (function (t, e, i) {
              let s = i6(t, i),
                { scroll: n } = e;
              return (n && (i9(s.x, n.offset.x), i9(s.y, n.offset.y)), s);
            })(s, n.root, this.visualElement.getTransformPagePoint()),
            o = { x: iz((t = n.layout.layoutBox).x, r.x), y: iz(t.y, r.y) };
          if (i) {
            let t = i(
              (function ({ x: t, y: e }) {
            ...
            ((this.hasMutatedConstraints = !!t), t && (o = i_(t)));
          }
          return o;
        }
        startAnimation(t) {
          ...
          iG((t) => {
            ...
            if (e && !1 !== this.constraints) {
              ...
              s[t] = (function (t, e) {
                ...
                return (
                  n > s
                    ? (i = b(e.min, e.max - s, t.min))
                    : s > n && (i = b(t.min, t.max - n, e.min)),
                  tA(0, 1, i)
                );
        ...
        addListeners() {
          ...
          let t = iE(this.visualElement.current, "pointerdown", (t) => {
      ...
      class sr extends iP {
        ...
        createPanHandlers() {
          ...
          return {
            ...
            onMove: i,
            onEnd: (t, e) => {
              (delete this.session, s && Z.postRender(() => s(t, e)));
            },
          };
        }
        mount() {
      ...
      let sf = {
        ...
        sv = {},
        { schedule: sg, cancel: sy } = q(queueMicrotask, !1);
      ...
      let sA = ["TopLeft", "TopRight", "BottomLeft", "BottomRight"],
        sM = sA.length,
        sV = (t) => ("string" == typeof t ? parseFloat(t) : t),
        sE = (t) => "number" == typeof t || t$.test(t);
      function sk(t, e) {
      ...
      let sD = sR(0, 0.5, tT),
        sC = sR(0.5, 0.95, N);
      function sR(t, e, i) {
        return (s) => (s < t ? 0 : s > e ? 1 : i(b(t, e, s)));
      }
      function sL(t, e) {
        ((t.min = e.min), (t.max = e.max));
      }
      function sj(t, e) {
        (sL(t.x, e.x), sL(t.y, e.y));
      }
      function sF(t, e) {
      ...
      function sO(t, e, [i, s, n], r, o) {
        !(function (t, e = 0, i = 1, s = 0.5, n, r = t, o = t) {
          if (
            (tN.test(e) &&
              ((e = parseFloat(e)), (e = ek(o.min, o.max, e / 100) - o.min)),
            "number" != typeof e)
          )
            return;
          let a = ek(r.min, r.max, s);
          (t === r && (a -= e),
            (t.min = sB(t.min, e, i, a, n)),
            (t.max = sB(t.max, e, i, a, n)));
        })(t, e[i], e[s], e[n], e.scale, r, o);
      }
      let sU = ["x", "scaleX", "originX"],
        sI = ["y", "scaleY", "originY"];
      function sN(t, e, i, s) {
        (sO(t.x, e, sU, i ? i.x : void 0, s ? s.x : void 0),
          sO(t.y, e, sI, i ? i.y : void 0, s ? s.y : void 0));
      }
      function s$(t) {
      ...
      let sZ = {
        ...
        sG = "undefined" != typeof window && void 0 !== window.MotionDebug,
        s_ = ["", "X", "Y", "Z"],
      ...
      function s1({
        ...
        return class {
            ...
            ((this.id = sQ++),
              ...
              (this.updateProjection = () => {
                ((this.projectionUpdateScheduled = !1),
                  ...
                  sG && window.MotionDebug.record(sZ));
              }),
          ...
          addEventListener(t, e) {
            return (
              this.eventHandlers.has(t) || this.eventHandlers.set(t, new ts()),
              ...
              t(e, () => {
                ((this.root.updateBlockedByResize = !0),
                  ...
                  (i = (function (t, e) {
                    ...
                    return (Z.read(s, !0), () => G(s));
                  })(s, 250)),
                  sp.hasAnimatedSinceResize &&
                    ((sp.hasAnimatedSinceResize = !1), this.nodes.forEach(nt)));
              });
            }
                ...
                this.addEventListener(
                  ...
                  ({
                    ...
                    let n =
                      ...
                      l = !this.targetLayout || !sY(this.targetLayout, s) || i,
                      h = !e && i;
                    if (
                      ...
                      let e = { ...v(n, "layout"), onPlay: o, onComplete: a };
          ...
          update() {
            ...
            (this.isUpdating || this.nodes.forEach(s6),
              (this.isUpdating = !1),
              ...
              this.clearAllSnapshots());
            let t = tt.now();
            ((_.delta = tA(0, 1e3 / 60, t - _.timestamp)),
              (_.timestamp = t),
              (_.isProcessing = !0),
              J.update.process(_),
              J.preRender.process(_),
              J.render.process(_),
              (_.isProcessing = !1));
          }
          didUpdate() {
          ...
          clearAllSnapshots() {
            (this.nodes.forEach(s4), this.sharedNodes.forEach(nn));
          }
          ...
          applyTransform(t, e = !1) {
            ...
            for (let t = 0; t < this.path.length; t++) {
              ...
              (!e &&
                ...
                s.scroll &&
                s !== s.root &&
                i7(i, { x: -s.scroll.offset.x, y: -s.scroll.offset.y }),
                i0(s.latestValues) && i7(i, s.latestValues));
            }
            return (i0(this.latestValues) && i7(i, this.latestValues), i);
          }
          removeTransform(t) {
            let e = iZ();
            sj(e, t);
            ...
            return (i0(this.latestValues) && sN(e, this.latestValues), e);
          }
          setTargetDelta(t) {
            ((this.targetDelta = t),
          ...
          calcProjection() {
            ...
            if (
              ...
              i &&
                ...
                (s = !1),
              this.resolvedRelativeTargetAt === _.timestamp && (s = !1),
              s)
            )
              return;
                ...
                for (let a = 0; a < o; a++) {
                  ...
                  (!o ||
                    ...
                    (s &&
                      ...
                      n.scroll &&
                      n !== n.root &&
                      i7(t, { x: -n.scroll.offset.x, y: -n.scroll.offset.y }),
                    r && ((e.x *= r.x.scale), (e.y *= r.y.scale), i3(t, r)),
                    s && i0(n.latestValues) && i7(t, n.latestValues));
                }
                  ...
                  (function (t, e, i, s, n, r) {
                    ...
                    for (let n = 0; n < sM; n++) {
                      ...
                      (void 0 !== o || void 0 !== a) &&
                        ...
                        a || (a = 0),
                        0 === o || 0 === a || sE(o) === sE(a)
                          ? ((t[r] = Math.max(ek(sV(o), sV(a), s), 0)),
                            (tN.test(a) || tN.test(o)) && (t[r] += "%"))
                          : (t[r] = a));
                    }
                    (e.rotate || i.rotate) &&
                      (t.rotate = ek(e.rotate || 0, i.rotate || 0, s));
              ...
              (this.pendingAnimation = Z.update(() => {
                ((sp.hasAnimatedSinceResize = !0),
                  (this.currentAnimation = (function (t, e, i) {
                    let s = tl(0) ? 0 : ta(0);
                    return (s.start(id("", s, 1e3, i)), s.animation);
                  })(0, 0, {
                    ...t,
                    onUpdate: (e) => {
          ...
          applyTransformsToTarget() {
            ...
            if (e && i && s) {
              if (
                ...
                let s = iB(this.layout.layoutBox.y);
          ...
          registerSharedNode(t, e) {
            (this.sharedNodes.has(t) || this.sharedNodes.set(t, new sq()),
          ...
          resetSkewAndRotation() {
            ...
            for (let e = 0; e < s_.length; e++)
              (s0(`rotate${s_[e]}`, t, s, this.animationValues),
                s0(`skew${s_[e]}`, t, s, this.animationValues));
          ...
          getProjectionStyles(t) {
            ...
            if (this.needsReset)
              return (
                ...
                (s.opacity = ""),
                (s.pointerEvents =
                  sS(null == t ? void 0 : t.pointerEvents) || ""),
      ...
      function s5(t) {
        ...
        if (t.isLead() && t.layout && i && t.hasListeners("didUpdate")) {
          ...
          let a = iK();
          r
            ? iU(a, t.applyTransform(s, !0), i.measuredBox)
            : iU(a, e, i.layoutBox);
          let l = !sW(o),
            h = !1;
          if (!t.resumeFrom) {
      ...
      function nr(t, e, i) {
        ((t.translate = ek(e.translate, 0, i)),
          (t.scale = ek(e.scale, 1, i)),
          (t.origin = e.origin),
          (t.originPoint = e.originPoint));
      }
      function no(t, e, i, s) {
        ((t.min = ek(e.min, i.min, s)), (t.max = ek(e.max, i.max, s)));
      }
      function na(t) {
      ...
      let nl = { duration: 0.45, ease: [0.4, 0, 0.1, 1] },
        ...
        nu = nh("applewebkit/") && !nh("chrome/") ? Math.round : N;
      function nd(t) {
      ...
      function nc(t, e, i) {
        return (
          "position" === t ||
          ("preserve-aspect" === t && !(0.2 >= Math.abs(sX(e) - sX(i))))
        );
      }
      function np(t) {
        var e;
              ...
              let [s, n, r] = E(t, i),
                o = (t) => {
                  ...
                  let r = e(t),
                    ...
                    a = (t) => {
                      o(t, i.useGlobalTarget || D(s, t.target));
                    },
                    l = (t) => {
                      o(t, !1);
                    };
        ...
        startObserver() {
          ...
          return (function (t, e, i) {
            let s = (function ({ root: t, ...e }) {
              ...
              return (
                s[n] ||
                  (s[n] = new IntersectionObserver(nA, { root: t, ...e })),
                s[n]
              );
            })(e);
            return (
      ...
      let nj = "undefined" != typeof window,
        nF = {
          animation: [
            "animate",
            "variants",
        ...
        nB = {};
      for (let t in nF) nB[t] = { isEnabled: (e) => nF[t].some((t) => !!e[t]) };
      let nO = Symbol.for("motionComponentSymbol"),
        nU = nj ? sh.useLayoutEffect : sh.useEffect,
        nI = [
          "animate",
          "circle",
          "defs",
      ...
      let n$ = (t) => (e, i) => {
          let s = (0, sh.useContext)(nD),
            r = (0, sh.useContext)(su),
            o = () =>
              (function (
                {
      ...
      function n1(t, e, i, s) {
        for (let i in (nQ(t, e, void 0, s), e.attrs))
          t.setAttribute(n0.has(i) ? i : tu(i), e.attrs[i]);
      }
      ...
      let n9 = ["x", "y", "width", "height", "cx", "cy", "r"],
        n4 = {
          useVisualState: n$({
            scrapeMotionValuesFromProps: n3,
            createRenderState: n_,
            onUpdate: ({
              props: t,
              prevProps: e,
              current: i,
              ...
              o &&
                Z.read(() => {
                  (!(function (t, e) {
                    ...
                    Z.render(() => {
                      (nZ(s, n, nJ(i.tagName), t.transformTemplate), n1(i, s));
                    }));
                });
            },
          }),
      ...
      function n6(t, e, i) {
        for (let s in e) tl(e[s]) || n2(s, i) || (t[s] = e[s]);
      }
      let n8 = new Set([
        "animate",
        "exit",
      ...
      class rl {
        ...
        constructor(
          ...
          ((this.current = null),
            ...
            (this.scheduleRender = () => {
              ...
              this.renderScheduledAt < t &&
                ((this.renderScheduledAt = t), Z.render(this.render, !1, !0));
            }));
          ...
          ((this.onUpdate = h),
            ...
            (this.isControllingVariants = nC(e)),
            (this.isVariantNode = nR(e)),
        ...
        update(t, e) {
          ...
          ((this.prevMotionValues = (function (t, e, i) {
            for (let s in e) {
              let n = e[s],
                r = i[s];
              if (tl(n)) t.addValue(s, n);
              else if (tl(r)) t.addValue(s, ta(n, { owner: t }));
              else if (r !== n) {
                if (t.hasValue(s)) {
                  let e = t.getValue(s);
                  ...
                  t.addValue(s, ta(void 0 !== e ? e : n, { owner: t }));
                }
              }
            }
        ...
        getValue(t, e) {
          ...
          return (
            void 0 === i &&
              void 0 !== e &&
              ((i = ta(null === e ? void 0 : e, { owner: this })),
              this.addValue(t, i)),
            i
          );
        }
        readValue(t, e) {
          ...
          return (
            null != s &&
              ("string" == typeof s && (em(s) || tS(s))
                ? (s = parseFloat(s))
                : !rr(s) && t1.test(e) && (s = et(t, e)),
              this.setBaseTarget(t, tl(s) ? s.get() : s)),
            tl(s) ? s.get() : s
          );
        }
        setBaseTarget(t, e) {
      ...
      class rh extends rl {
        constructor() {
          (super(...arguments), (this.KeyframeResolver = eS));
        }
        ...
        readValueFromInstance(t, e) {
          ...
          }
          {
            let i = window.getComputedStyle(t),
              s = (ev(e) ? i.getPropertyValue(e) : i[e]) || 0;
      ...
      class rd extends rh {
        ...
        readValueFromInstance(t, e) {
          ...
          return ((e = n0.has(e) ? e : tu(e)), t.getAttribute(e));
        }
        scrapeMotionValuesFromProps(t, e, i) {
          return n3(t, e, i);
        }
      ...
      let rc = (function (t) {
        ...
        ((so = {
          ...
          hover: { Feature: ny },
          pan: { Feature: sr },
          drag: { Feature: ss, ProjectionNode: nv, MeasureLayout: sw },
        ...
        function (t, { forwardMotionProps: e } = { forwardMotionProps: !1 }) {
          return (function (t) {
            ...
            function h(t, e) {
              ...
              if (!u && nj) {
                ...
                ((s = t.MeasureLayout),
                  (d.visualElement = (function (t, e, i, s, n) {
                    var r, o;
                    let { visualElement: a } = (0, sh.useContext)(nD),
                      l = (0, sh.useContext)(nE),
                      h = (0, sh.useContext)(su),
                      u = (0, sh.useContext)(nk).reducedMotion,
                      d = (0, sh.useRef)(null);
                    ((s = s || l.renderer),
                      !d.current &&
                        s &&
              ...
              return (0, sl.jsxs)(nD.Provider, {
                value: d,
                children: [
                  s && d.visualElement
                    ? (0, sl.jsx)(s, { visualElement: d.visualElement, ...h })
                    : null,
                  r(
                    l,
                    t,
            ...
            let u = (0, sh.forwardRef)(h);
            return ((u[nO] = l), u);
          })({
            ...(nN(t) ? n4 : n7),
            preloadedFeatures: so,
            useRender: (function (t = !1) {
              return (e, i, s, { latestValues: n }, r) => {
                let o = (
                    nN(e)
                      ? function (t, e, i, s) {
                          let n = (0, sh.useMemo)(() => {
                            let i = n_();
                            return (
                              nZ(i, e, nJ(s), t.transformTemplate),
                  ...
                  { children: h } = i,
                  u = (0, sh.useMemo)(() => (tl(h) ? h.get() : h), [h]);
                return (0, sh.createElement)(e, { ...l, children: u });
              };
            })(e),
            createVisualElement: sa,
            Component: t,
          });
        }),
      );
