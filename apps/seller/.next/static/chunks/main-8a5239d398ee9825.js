(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [179],
  {
    ...
    163: (e, t, r) => {
      "use strict";
      (Object.defineProperty(t, "__esModule", { value: !0 }), r(704));
      let n = r(3582);
      ((window.next = {
        version: n.version,
        get router() {
    ...
    4409: (e, t, r) => {
      ...
      let n = r(6255)._(r(333)).default.createContext({});
    },
    54: (e, t) => {
      "use strict";
      function r(e) {
    ...
    299: (e, t, r) => {
      ...
      let n = r(6255)._(r(333)).default.createContext(null);
    },
    301: (e, t, r) => {
      "use strict";
      (Object.defineProperty(t, "__esModule", { value: !0 }),
      ...
      class V {
        ...
        async change(e, t, r, n, o) {
          ...
          (this._inFlightRoute &&
            this.clc &&
            (z ||
              V.events.emit("routeChangeError", N(), this._inFlightRoute, Q),
            this.clc(),
            (this.clc = null)),
            (r = (0, v.addBasePath)(
              (0, P.addLocale)(
          ...
          if (!H && this.onlyAHashChange(J) && !Z) {
            ...
            try {
              ...
              throw (
                (0, l.default)(e) &&
                  e.cancelled &&
                  V.events.emit("routeChangeError", e, J, Q),
                e
              );
            }
          ...
          let ei = !!(
            ...
            es =
              !n.shallow &&
              (await L({ asPath: r, locale: G.locale, router: this }));
          if (
            (H && es && (W = !1),
            W &&
              "/_error" !== et &&
          ...
          try {
            ...
            if ("type" in a) {
              ...
              return (
                q({ url: a.destination, router: this }),
                new Promise(() => {})
              );
            }
            let i = a.Component;
            if (
              ...
              if (
                ((G.isPreview = !!a.props.__N_PREVIEW), a.props.notFound === B)
              ) {
                let e;
                try {
            ...
            if (
              ...
              if (a.error)
                throw (
                  H || V.events.emit("routeChangeError", a.error, J, Q),
                  a.error
                );
        ...
        async prefetch(e, t, r) {
          ...
          let n = (0, h.parseRelativeUrl)(e),
            ...
            f = await L({ asPath: t, locale: d, router: this });
          ((n.pathname = k(n.pathname, u)),
