...
**Lowest binding constraint:** perceived likelihood + dream outcome. "Will these actually save me time, for _my_ setup?"
...
**The pattern:** in every case, the price barely moved (or didn't move at all). What moved was the _structure_ of the offer — naming, framing, guaranteeing, sequencing.
