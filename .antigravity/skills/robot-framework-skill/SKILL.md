...
Use this skill when you need generates Robot Framework tests in keyword-driven syntax with Python. Supports SeleniumLibrary, RequestsLibrary, and custom keywords. Use when user mentions "Robot Framework", "*** Test Cases _**", "SeleniumLibrary", ".robot file". Triggers on: "Robot Framework", "**_ Test Cases ***",...
