...
- Query re-writer: _Change user input text into a query text using an LLM_
- Query decomposition: _Change query into multiple sub-queries each re-written with an LLM_
- Filtering: _Use an LLM to define filters on the collection_
- Re-ranking: _Score the final results by a more advanced model_
- Prompt engineering: _Add chain of thought, Tree of thoughts, ReAct_
