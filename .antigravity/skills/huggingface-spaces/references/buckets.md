...
Bucket I/O is fine for occasional metadata reads (the feed pattern above) or saving user information. It is _not_ fine as the path your model loader streams gigabytes through every cold start.
