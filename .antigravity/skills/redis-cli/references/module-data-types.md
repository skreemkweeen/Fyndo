...
**Compaction:** `TS.CREATERULE` automatically computes aggregation as data arrives. Only data added _after_ rule creation is processed. Destination key must already exist.
