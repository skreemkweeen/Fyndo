...
const getPublicUser = pick<User, "id" | "name" | "email">([
  "id",
  "name",
  "email",
]);
...
function sanitizeForLogging(
  user: User,
): Omit<User, "passwordHash" | "internalNotes"> {
...
function mergeSettings(
  ...
  return {
    theme:
      userSettings.theme !== undefined ? userSettings.theme : defaults.theme,
    fontSize:
      userSettings.fontSize !== undefined
