...
This file covers _how to behave_ when you encounter soft-deprecated SwiftUI APIs. For the actual list of deprecated-to-modern transitions, see `references/latest-apis.md`.
...
If a _different_ view in the same file uses a soft-deprecated API, ignore it entirely (see the scoping rule).
