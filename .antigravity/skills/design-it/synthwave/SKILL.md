  ...
  return (
    <View style={{ alignItems: "center", height: 80 }}>
      ...
      <Text
        style={[
          baseStyle,
          { textShadowColor: "#FF00FF", textShadowRadius: 30 },
        ]}
      >
        {text}
      </Text>
      ...
      <Text
        style={[
          baseStyle,
          { textShadowColor: "#FF00FF", textShadowRadius: 15 },
        ]}
      >
        {text}
      </Text>
      {/* Core Glow */}
      <Text
        style={[baseStyle, { textShadowColor: "#FFF", textShadowRadius: 5 }]}
      >
        {text}
      </Text>
      {/* Crisp White Core */}
...
const SynthwaveScreen = () => (
  <View
    style={{ flex: 1, backgroundColor: "#090014", justifyContent: "center" }}
  >
    <NeonText text="Outrun" />
