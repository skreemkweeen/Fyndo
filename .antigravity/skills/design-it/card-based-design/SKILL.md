    ...
    <View style={styles.card}>
      ...
      <View style={styles.contentArea}>
        ...
        <Text style={styles.description} numberOfLines={2}>
          A brief description of the content inside this discrete card
          container.
        </Text>
      </View>
    </View>
...
- **DON'T**: Put too much text in a card. If the user has to scroll _within_ a card, the card is too big.
