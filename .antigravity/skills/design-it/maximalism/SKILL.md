...
const MaximalismScreen = () => {
  return (
    <ScrollView style={{ flex: 1, backgroundColor: "#0F172A" }}>
      <View
        style={{ padding: 16, flexDirection: "row", flexWrap: "wrap", gap: 4 }}
      >
        ...
        {/* Small Dense Items */}
        <View style={[styles.item, { width: "32%" }]}>
          <Text style={styles.text}>1892</Text>
        </View>
        <View style={[styles.item, { width: "32%" }]}>
          <Text style={styles.text}>Vol. II</Text>
        </View>
        <View style={[styles.item, { width: "32%" }]}>
          <Text style={styles.text}>Arch</Text>
        </View>
      </View>
    </ScrollView>
  );
