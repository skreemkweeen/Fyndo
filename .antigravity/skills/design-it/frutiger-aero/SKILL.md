...
- **Typography**: Clean, highly legible humanist sans-serifs (like the font _Frutiger_, `Segoe UI`, or `Myriad Pro`).
...
.aero-btn {
  ...
  box-shadow:
    ...
    /* Top edge highlight */ inset 0 15px 15px rgba(255, 255, 255, 0.3),
    /* Convex plastic shine */ 0 4px 6px rgba(0, 0, 0, 0.2); /* Drop shadow */
}
