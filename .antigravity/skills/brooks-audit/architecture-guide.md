...
_The most architecturally consequential risk — scan this first._
...
A _seam_ is a place in the architecture where behavior can be altered without editing source
...
- Not a finding: a single team owns a monorepo with multiple logical modules — Conway's Law
  misalignment requires _separate teams_ to be meaningful
