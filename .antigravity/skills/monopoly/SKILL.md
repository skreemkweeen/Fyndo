...
2. **Clarifying Questions** — Wait for the candidate to ask questions. If they skip this, prompt them: _"Before jumping in, what clarifying questions would you ask?"_
...
6. **Bottleneck Discussion** — Ask: _"Where would this fail at 10× scale?"_
...
9. **Think in failure modes** — always ask: _"What happens when this component goes down?"_
...
> _"A system is only as strong as its weakest component under failure."_
...
_MONOPOLY — Own Every Block of Your Architecture._
