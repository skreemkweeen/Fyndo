...
The Site Health screen is diagnostic, not prescriptive. It tells the site owner _that_ something is wrong
(e.g. "you should use a persistent object cache") but not _how_ to fix it, and it mixes items that are
