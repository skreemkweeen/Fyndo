...
- Confirm all sub-assertions are met. For example, _"Verify that the app is on the Home screen and the logo is visible"_ fails if the home screen is not displayed **or** the logo is missing.
