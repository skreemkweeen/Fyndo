...
- **Do NOT present importance scores as business criticality.** Always explain that the importance score is a _computed_ metric (query frequency, downstream dependencies, usage patterns), not business-defined criticality.
