...
> **Official documentation:** [https://rclone.org/http/](https://rclone.org/http/)
...
| content-disposition-filename | Filename retrieved from Content-Disposition header | string | file.txt   | N         |
