...
> **Official documentation:** [https://rclone.org/hidrive/](https://rclone.org/hidrive/)
...
that implies the refresh token is _invalid_ or _expired_.
...
HiDrive is able to store symbolic links (_symlinks_) by design,
...
_This does not affect the `.rclonelink`-files
that rclone uses to encode and store symbolic links._
