...
> **Official documentation:** [https://rclone.org/googlecloudstorage/](https://rclone.org/googlecloudstorage/)
...
_gcloud impersonate-service-account_. Access tokens protect security by avoiding
...
- _roles/storage.objectUser_ -- read-write access but no admin privileges
- _roles/storage.objectViewer_ -- read-only access to objects
- _roles/storage.admin_ -- create buckets & administrative roles
...
hit `CTRL-C` when you see _waiting for code_. This will save the config without
doing oauth flow
