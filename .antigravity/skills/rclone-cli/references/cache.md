...
> **Official documentation:** [https://rclone.org/cache/](https://rclone.org/cache/)
...
- `cache-workers`: _Configured value_ during confirmed playback or _1_ all the
  other times
...
- **withData** = true/false to delete cached data (chunks) as
  well _(optional, false by default)_
