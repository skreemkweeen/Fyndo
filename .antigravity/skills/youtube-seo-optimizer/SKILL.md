...
**Content type** — If unclear from what they said, ask once: _"Is this a regular video, a podcast episode, or a Short/Reel?"_
...
If they ask for a Short without mentioning a source video, ask: _"Which video should I pull the Short from?"_ — once they tell you, treat the Short as the primary request and use Mode E directly (no need to also package the source video).
